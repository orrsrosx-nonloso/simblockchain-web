        ...
        >
          <div class="demo-drawer__content">
            <el-form :model="drwaerDateBlock">
              ...
              >
              <c-scrollbar maxWidth="440px" trigger="hover">
                <el-descriptions :column="1" border v-for="e in blockTableData">
                  <el-descriptions-item
                    label= e.id
                    label-align="center"
                    align="center"
        ...
        >
          <div class="demo-drawer__content">
            <el-form :model="drwaerDateNode">
              ...
              >
                <c-scrollbar maxWidth="440px" trigger="hover">
                <el-descriptions :column="1" border v-for="e in nodeTableData">
                  <el-descriptions-item
                    label= e.id
                    label-align="center"
                    align="center"
  ...
  setup() {
    ...
    const findTransList1 = (list) => {
      ...
      FindTransListBYid(List).then((res) => {
        ...
        transs[0].hash = "sdadasda";
        // blockTableData.length = 0;
        // blockTableData = res;
        // let aa =blockTableData;
        blockTableData = transs;
    ...
    const findTransList2 = (list) => {
      ...
      FindTransListBYid(List).then((res) => {
        ...
        for (let i = 0; i < lengths; i++) {
          transs.id = res[i].id;
          transs.hash = res[i].hash;
          transsss.push(transs);
        }
        nodeTableData = transsss;
        let aa = nodeTableData;
    ...
    let blockTableData = reactive([
      {
        id: 1,
        hash: "000a6c2a3347ff2ef0a48ae2508716cfab42ae75b71d52ab36d2815ead9efa35",
      },
    ]);
