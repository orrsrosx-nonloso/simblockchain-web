  ...
  <div class="rightMapControl">
    <el-row>
      <el-col :span="24">
              ...
              <c-scrollbar maxHeight="280px" height="280px" trigger="hover">
                <div v-for="item in nodeMesVisList" class="event-content">
                  ...
                  <div class="event-detail" @click="showNodeDetial(item)">
                    <el-icon class="event-detail-buttom"
                      ><MoreFilled
                    /></el-icon>
                  </div>
                </div>
        ...
        <el-dialog
          v-model="dialogNodeDetailVisible"
          title="节点详情"
          width="50%"
        >
        ...
        <div class="reStarteSim">
          <el-button type="primary" @click="reStartSim" plain
            >再次仿真</el-button
          >
        </div>
...
.leftUserControl {
  ...
  height: 597px;
  float: left;
  box-shadow: 0 1px 4px 0 rgba(110, 108, 108, 0.1);
  border-radius: 4px;
